...
export default function Contact() {
  ...
  const handleSubmit = (event) => {
    ...
    const subject = `Summit Valor enquiry from ${form.name || "website visitor"}`;
    const body = [
      `Name: ${form.name}`,
      `Email: ${form.email}`,
    ...
    window.location.href = `mailto:hello@summitvalor.com.ng?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(body)}`;
  };
