...
export default function Hero() {
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto w-full max-w-7xl px-6 pt-32 pb-24 sm:pt-36 sm:pb-32 lg:pt-40 lg:pb-40">
        <motion.div
        ...
        >
          ...
          <h1 className="mx-auto mt-6 max-w-4xl text-4xl font-bold leading-tight text-white sm:text-5xl md:text-6xl lg:text-7xl">
            We help founders run
            <br />
            a calmer, cleaner business.
          </h1>

          <p className="mx-auto mt-6 max-w-3xl text-base leading-8 text-gray-200 sm:text-lg">
          ...
          <div className="mx-auto mt-8 grid max-w-4xl gap-3 text-sm text-gray-100 sm:grid-cols-3">
            <div className="flex items-center justify-center gap-2 rounded-2xl border border-white/15 bg-white/5 px-4 py-3 backdrop-blur-sm">
          ...
          <p className="mx-auto mt-8 max-w-3xl text-base leading-8 text-gray-200 sm:text-lg">
